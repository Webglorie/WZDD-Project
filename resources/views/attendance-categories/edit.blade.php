                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <span class="card-title">Aanwezigheid categorie aanpassen</span>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('attendance-categories.update', $attendanceCategory->id) }}"  role="form" enctype="multipart/form-data">
                                {{ method_field('PATCH') }}
                                @csrf
