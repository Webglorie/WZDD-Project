            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Update') }} Borrowed Equipment</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('borrowed-equipments.update', $borrowedEquipment->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
