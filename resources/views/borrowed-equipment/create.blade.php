    ...
    <main class="col-md-9 ms-sm-auto col-lg-9 px-md-4">
            <div class="breadcrumb-wrapper primary-wrapper first-pw">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        {{ Breadcrumbs::render('borrowed-equipments.create') }}
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Nieuwe uitgeleende hardware toevoegen</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('borrowed-equipments.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf

                            @include('borrowed-equipment.form')
