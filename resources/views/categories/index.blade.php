    ...
    <main class="col-md-9 ms-sm-auto col-lg-9 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center primary-wrapper less-padding">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAttendanceCategoryModal">
                Nieuwe AttendanceCategory toevoegen
            </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addAttendanceCategoryModalLabel">Nieuwe AttendanceCategory toevoegen</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" form="addAttendanceCategoryForm">Opslaan</button>
                        </div>
                    </div>
                </div>
            </div>
