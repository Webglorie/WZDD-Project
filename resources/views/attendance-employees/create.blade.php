            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Create') }} Attendance Employee</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('attendance-employees.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
